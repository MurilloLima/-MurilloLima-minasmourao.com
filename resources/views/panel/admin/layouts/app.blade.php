...
<body class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed">
    ...
    <!--CKeditor inicializa-->
    <script type="text/javascript" src="{{ url('assets/admin/tinymce/tinymce.min.js') }}"></script>
    <script type="text/javascript">
        tinymce.init({
            ...
            toolbar: [
                "styleselect | bold italic | alignleft aligncenter alignright alignjustify | bullist numlist outdent indent | link image | print preview media fullpage | forecolor backcolor emoticons",
             
            ],
            
            style_formats: [
                {title: 'Bold text', inline: 'b'},
                {title: 'text', inline: 'span'},
