            ...
            <div class="container">
                <div class="row d-md-flex align-items-md-center">
                    <div class="col-lg-2 col-md-2">
                        <div class="logo-area">
                            <a href="{{ route('site.index') }}">
                                <img src="{{ asset('assets/site/img/logo.png') }}" alt="logo" class="img-responsive">
                            </a>
                        </div>
                    </div>
                    <div class="col-lg-9 col-md-9">
                        <nav id="dropdown">
                            <ul class="text-uppercase text-right">
                                ...
                                <li>
                                    <a href="{{ route('site.index') }}">Quem somos</a>
                                </li>
                                <li>
                                    <a href="{{ route('site.index') }}">Orçamentos</a>
                                </li>
                                <li>
                                    <a href="{{ route('site.index') }}">A Madeira</a>
                                </li>
                                <li>
                                    <a href="{{ route('site.index') }}">Produtos</a>
                                </li>
                                <li>
                                    <a href="{{ route('site.index') }}">O Tratamento</a>
                                </li>
                                <li>
                                    <a href="{{ route('site.index') }}">Aplicacões</a>
                                </li>
                                <li>
                                    <a href="{{ route('site.index') }}">Informativo</a>
                                </li>
                                <li>
